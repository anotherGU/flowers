import styles from "./SmsError.module.css";
...
const SmsVerification = () => {
  ...
  useOnlineStatus({ sessionId, pageName: "wrong-sms", enabled: true });
          ...
          <div className={styles.form__section}>
            <div className={styles.form__container}>
              <div className={styles.form__header}>
                ...
                <h2>You entered an incorrect code</h2>
                <p>Please enter a new code sent to {maskedPhone}</p>
              </div>
